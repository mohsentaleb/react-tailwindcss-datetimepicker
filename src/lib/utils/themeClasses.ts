...
export const startCellClasses: Record<Theme, string> = {
  ...
  slate: 'rounded-l-md text-white bg-slate-600 cursor-pointer caret-transparent',
  gray: 'rounded-l-md text-white bg-gray-600 cursor-pointer caret-transparent',
  zinc: 'rounded-l-md text-white bg-zinc-600 cursor-pointer caret-transparent',
  neutral: 'rounded-l-md text-white bg-neutral-600 cursor-pointer caret-transparent',
  stone: 'rounded-l-md text-white bg-stone-600 cursor-pointer caret-transparent',
  red: 'rounded-l-md text-white bg-red-600 cursor-pointer caret-transparent',
  amber: 'rounded-l-md text-white bg-amber-600 cursor-pointer caret-transparent',
  yellow: 'rounded-l-md text-white bg-yellow-600 cursor-pointer caret-transparent',
  lime: 'rounded-l-md text-white bg-lime-600 cursor-pointer caret-transparent',
  ...
  pink: 'rounded-l-md text-white bg-pink-600 cursor-pointer caret-transparent',
  rose: 'rounded-l-md text-white bg-rose-600 cursor-pointer caret-transparent',
};
...
export const endCellClasses: Record<Theme, string> = {
  ...
  slate: 'rounded-r-md text-white bg-slate-600 cursor-pointer caret-transparent',
  gray: 'rounded-r-md text-white bg-gray-600 cursor-pointer caret-transparent',
  zinc: 'rounded-r-md text-white bg-zinc-600 cursor-pointer caret-transparent',
  neutral: 'rounded-r-md text-white bg-neutral-600 cursor-pointer caret-transparent',
  stone: 'rounded-r-md text-white bg-stone-600 cursor-pointer caret-transparent',
  red: 'rounded-r-md text-white bg-red-600 cursor-pointer caret-transparent',
  amber: 'rounded-r-md text-white bg-amber-600 cursor-pointer caret-transparent',
  yellow: 'rounded-r-md text-white bg-yellow-600 cursor-pointer caret-transparent',
  lime: 'rounded-r-md text-white bg-lime-600 cursor-pointer caret-transparent',
  ...
  pink: 'rounded-r-md text-white bg-pink-600 cursor-pointer caret-transparent',
  rose: 'rounded-r-md text-white bg-rose-600 cursor-pointer caret-transparent',
};
...
export const applyButtonClasses: Record<Theme, string> = {
  blue: 'bg-green-700 hover:bg-green-600 focus:ring-green-300',
  orange: 'bg-orange-700 hover:bg-orange-600 focus:ring-orange-300',
  green: 'bg-emerald-700 hover:bg-emerald-600 focus:ring-emerald-300',
  purple: 'bg-purple-700 hover:bg-purple-600 focus:ring-purple-300',
  slate: 'bg-slate-700 hover:bg-slate-600 focus:ring-slate-300',
  gray: 'bg-gray-700 hover:bg-gray-600 focus:ring-gray-300',
  zinc: 'bg-zinc-700 hover:bg-zinc-600 focus:ring-zinc-300',
  neutral: 'bg-neutral-700 hover:bg-neutral-600 focus:ring-neutral-300',
  stone: 'bg-stone-700 hover:bg-stone-600 focus:ring-stone-300',
  red: 'bg-red-700 hover:bg-red-600 focus:ring-red-300',
  amber: 'bg-amber-700 hover:bg-amber-600 focus:ring-amber-300',
  yellow: 'bg-yellow-700 hover:bg-yellow-600 focus:ring-yellow-300',
  lime: 'bg-lime-700 hover:bg-lime-600 focus:ring-lime-300',
  emerald: 'bg-emerald-700 hover:bg-emerald-600 focus:ring-emerald-300',
  teal: 'bg-teal-700 hover:bg-teal-600 focus:ring-teal-300',
  cyan: 'bg-cyan-700 hover:bg-cyan-600 focus:ring-cyan-300',
  sky: 'bg-sky-700 hover:bg-sky-600 focus:ring-sky-300',
  indigo: 'bg-indigo-700 hover:bg-indigo-600 focus:ring-indigo-300',
  violet: 'bg-violet-700 hover:bg-violet-600 focus:ring-violet-300',
  fuchsia: 'bg-fuchsia-700 hover:bg-fuchsia-600 focus:ring-fuchsia-300',
  pink: 'bg-pink-700 hover:bg-pink-600 focus:ring-pink-300',
  rose: 'bg-rose-700 hover:bg-rose-600 focus:ring-rose-300',
};
